...
//
// Below code is taken from https://github.com/GameDevEducation/UnityTutorial_SerializableDictionary/blob/master/Assets/SerializableDictionary/Editor/SerializableDictionaryDrawerUIE.cs
// under MIT licence
//
public class DicktionaryConverter<KeyType, ValueType> : UxmlAttributeConverter<Dicktionary<KeyType, ValueType>>
{
    static string ValueToString(object InValue) => System.Convert.ToString(InValue, CultureInfo.InvariantCulture);

    public override string ToString(Dicktionary<KeyType, ValueType> InSource)
    {
    ...
    public override Dicktionary<KeyType, ValueType> FromString(string InSource)
    {
        var OutputDictionary = new Dicktionary<KeyType, ValueType>();
...
[CustomPropertyDrawer(typeof(Dicktionary<,>), true)]
public class DicktionaryDrawerUIE : PropertyDrawer
{
